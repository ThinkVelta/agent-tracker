...
Chosen to exercise the row layout rather than to look tidy: all three states, two different parent directories (so the location field is
...
def main():
    ...
    for cwd, state, reason, age in DEMO:
        ...
        path = sessions / f"claude-code-demo-{name}.json"
